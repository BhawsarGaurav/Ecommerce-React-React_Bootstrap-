...
const regForAddress = RegExp('^[#.0-9a-zA-Z\s,-]+$')
    ...
    render() {
        ...
        return (
            ...
            <div className="container condiv">
                <h2 style={{textAlign:"center"}} >Fill the form to contact us.</h2>
                <form method="POST" onSubmit={this.formSubmit}>
                    ...
                    <input type="submit" value="Submit" className="btn btn-primary mt-3 md-3 "/>
                </form>
            </div>
            <Footer/>
            </>
